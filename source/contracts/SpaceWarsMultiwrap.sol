...
import "@thirdweb-dev/contracts/interfaces/IMultiwrap.sol";
...
contract SpaceWarsMultiwrap is
    Initializable,
    ContractMetadata,
    Royalty,
    Ownable,
    ...
    IMultiwrap
{
    ...
    bytes32 private constant MODULE_TYPE = bytes32("SpaceWarsMultiwrap");
    ...
    receive() external payable {
        require(msg.sender == nativeTokenWrapperAddress, "caller not native token wrapper.");
    }
