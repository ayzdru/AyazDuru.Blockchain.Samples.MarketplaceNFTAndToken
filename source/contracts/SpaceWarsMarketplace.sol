...
contract SpaceWarsMarketplace is
    Initializable,
    IMarketplace,
    ...
    IERC1155ReceiverUpgradeable
{
    ...
    bytes32 private constant MODULE_TYPE = bytes32("SpaceWarsMarketplace");
    ...
    mapping(address => bool) whitelistedAssetContractAddresses;

    /*///////////////////////////////////////////////////////////////
                                Modifiers
    //////////////////////////////////////////////////////////////*/

     modifier isWhitelistedAssetContractAddress(address _assetContractAddress) {
      require(whitelistedAssetContractAddresses[_assetContractAddress], "Whitelist: You need to be whitelisted asset contract address");
      _;
    }
    ...
    function initialize(        
        ...
        address[] memory _whitelistedAssetContractAddresses,
        ...
        _setupRole(ASSET_ROLE, address(0));
         ...
         for (uint256 i = 0; i < _whitelistedAssetContractAddresses.length; i++) {
            whitelistedAssetContractAddresses[_whitelistedAssetContractAddresses[i]] = true;
        }
    }
    ...
    function createListing(ListingParameters memory _params) external override isWhitelistedAssetContractAddress(_params.assetContract) {
    ...
    //////////////////////////////////////////////////////////////*/
     ...
     function verifyWhitelistedAssetContractAddress(address _whitelistedAssetContractAddress) public view returns(bool) {
      bool userIsWhitelisted = whitelistedAssetContractAddresses[_whitelistedAssetContractAddress];
    ...
    function addWhitelistedAssetContractAddress(address _whitelistedContractAssetAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
      whitelistedAssetContractAddresses[_whitelistedContractAssetAddress] = true;
    }

    function removeWhitelistedAssetContractAddress(address _whitelistedContractAssetAddress)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        
        require(
            whitelistedAssetContractAddresses[_whitelistedContractAssetAddress],
            "Error: Sender is not whitelisted"
        );
        
       delete whitelistedAssetContractAddresses[_whitelistedContractAssetAddress];
    }
